...
<h1 className="mb-4 fw-bold text-center" style={{letterSpacing:1}}>Products</h1>
...
<ProductCard product={p} onViewDetails={handleViewDetails} />
...
<ProductDetailsModal product={selectedProduct} onHide={() => setSelectedProduct(null)} />
